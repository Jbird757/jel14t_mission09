...
namespace jel14t_mission09.Migrations
{
    public partial class AddCheckout : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Checkout", x => x.transactionId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CheckouttransactionId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BasketLineItem_Checkout_CheckouttransactionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BasketLineItem_CheckouttransactionId",
                table: "BasketLineItem",
